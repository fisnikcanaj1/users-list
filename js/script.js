                    ...
                    .append(`<div class='col-sm-4 item'>
                                        ...
                                        <div class='card'>
                                            ...
                                            <div class='card-body'>
                                                ...
                                                <a data-toggle='modal' data-target='#myModal' class='modal-item' data-id="${val.id}"><button class='btn-block btn-primary'>Show more data</button></a>
                                            </div>
                                        </div>
                                </div>
                                `);
...
function appendDataToModal(data) {
    $('.modal-title').html('Name: ' + data.name);
